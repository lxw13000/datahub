 ...
 * 面向容器编排和部署脚本的严格就绪检查。
 *
 * <p>/health只说明Web进程存活；/ready还会按server-mode验证ES访问能力和
 * T+1任务索引。query实例只承担查询，不要求同步能力就绪。</p>
 */
@RestController
public class ReadyController {
    ...
    public ResponseEntity<ReadyStatus> ready() {
        ...
        try {
            ...
            Optional<SyncTableConfig> smokeTable = importProperties.getTPlusOneTables().stream().findFirst();
